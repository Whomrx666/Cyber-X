...
# Yang gapaham cara makenya contact ke telegram author https://t.me/Whomr_X

import subprocess as qq

banner = f"""
    \033[32m         
 _______  __   __  _______  _______  ______           __   __ 
|       ||  | |  ||  _    ||       ||    _ |         |  |_|  |
|       ||  |_|  || |_|   ||    ___||   | ||   ____  |       |
|       ||       ||       ||   |___ |   |_||_ |____| |       |
|      _||_     _||  _   | |    ___||    __  |        |     | 
|     |_   |   |  | |_|   ||   |___ |   |  | |       |   _   |
|_______|  |___|  |_______||_______||___|  |_|       |__| |__|
...
try:
    ...
    username = "Cyber-X"                                           # ganti usernamenya
